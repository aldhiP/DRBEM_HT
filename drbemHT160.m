...
clear;clc;
fid=fopen('inputHT160.txt'); % 160 segmen
...
fid=fopen('interiorHT.txt'); % 225 titik interior
data=fscanf(fid,'%g %g \n',[2,inf]);
fclose(fid);
xint=data(1,:);
yint=data(2,:);
...
fid=fopen('U-dan-Un-HT_160.txt','wt');
...
fid=fopen('Numerik_vs_Analitik_HT_160.txt','wt');
